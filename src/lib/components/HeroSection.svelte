...
<section class="hero">
  <div class="hero-showcase text-center bold">
    ...
    <h1 class="purple mb-xs">BEGLIUM</h1>
    <h4 class="italic semi-bold">There's no need to make the mistakes I made.</h4>
  ...
  <div class="hero-text white text-center">
    ...
    {:else}
      ...
      <p class="light-grey mb-l">
        I moved to Belgium seven years ago. The process was painfull and difficult. I 
